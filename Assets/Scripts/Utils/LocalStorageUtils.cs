...
public static class LocalStorageUtils
{
    ...
    public static string GetString(string key)
    {
        ...
        {
            return MainUtils.Decrypt(value);
        }
    ...
    {
        PlayerPrefs.SetString(key, MainUtils.Encrypt(value));
    }
    ...
    public static List<string> GetRatedApp()
    {
        ...
        {
            var d = JsonConvert.DeserializeObject(PlayerPrefs.GetString(_RATED_APP), typeof(List<string>));
